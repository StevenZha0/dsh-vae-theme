...
export function apply(ctx) {
  ...
  registerRoute('/vae-theme-status', async (req, res) => {
    ...
    try {
      ...
      out.checks.runtimeHasLogo = runtime.indexOf('vae-brand') !== -1
      out.checks.runtimeHasGoldNav = runtime.indexOf('vae-gold-nav') !== -1
      out.checks.noBackdropBlur = runtime.indexOf('backdrop-filter') === -1
      out.checks.runtimeHasGoldBrand = runtime.indexOf('vae-brand') !== -1
      out.checks.runtimeHasRain = runtime.indexOf('vae-rain') !== -1
      out.checks.runtimeHasLyric = runtime.indexOf('vae-lyric') !== -1
